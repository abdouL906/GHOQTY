...
ViewTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if ViewTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
      repeat
        pcall(function()
          game.Workspace.CurrentCamera.CameraSubject = Players[TargetedPlayer].Character.Humanoid
        end)
        task.wait(0.5)
      until ViewTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,0)
...
FocusTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if FocusTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
      repeat
        pcall(function()
        ...
        task.wait(0.2)
      until FocusTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,0)
    end
  end
end)
...
BenxTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if BenxTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
      ...
      repeat
        ...
        task.wait()
      until BenxTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,0)
      StopAnim()
...
HeadsitTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if HeadsitTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
      repeat
        pcall(function()
          if not GetRoot(plr):FindFirstChild("BreakVelocity") then
            pcall(function()
...
StandTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if StandTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
      ...
      repeat
        ...
        task.wait()
      until StandTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,0)
      StopAnim()
      if GetRoot(plr):FindFirstChild("BreakVelocity") then
        GetRoot(plr).BreakVelocity:Destroy()
      end
...
BackpackTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if BackpackTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
      repeat
        pcall(function()
          if not GetRoot(plr):FindFirstChild("BreakVelocity") then
            pcall(function()
...
DoggyTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if DoggyTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,139) then
...
DragTarget_Button.MouseButton1Click:Connect(function()
  if TargetedPlayer ~= nil then
    ...
    if DragTarget_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,0,13939) then
